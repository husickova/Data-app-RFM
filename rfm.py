...
try:
    ...
    if selected_button == "TO DO Analysis":
        ...
        def get_recommendation():
            ...
            prompt = (
                f"Based on the following RFM data, provide a brief summary of the customer segments and offer two engagement recommendations for each segment:\n\n"
                f"{filtered_data_str}\n\n"
                f"Summarize the key metrics and customer behavior for each segment."
            )
