    ...
    if selected_button == "TO DO Analysis":
        ...
        def get_recommendation():
            ...
            prompt = (
                ...
                f"    Discuss how purchasing patterns vary between groups.\n\n"
                f"Customer Value:\n"
                f"    Compare the value of different groups to each other.\n"
                f"    Identify which groups are the most and least valuable.\n\n"
                f"Engagement Recommendations:\n"
                f"    Provide 2 key recommendations on how to engage with each customer group.\n"
                f"    Ensure the recommendations are actionable and data-driven.\n"
                f"Here is the data:\n{filtered_data_str}"
            )
