    ...
    if selected_button == "TO DO Analysis":
        ...
        def get_recommendation():
            ...
            prompt = (
                ...
                f"    Discuss how purchasing patterns of Champions vary.\n"
                f"Customer Value:\n"
                ...
                f"02. Loyal Customers:\n"
                f"Purchasing Patterns:\n"
                f"    Discuss how purchasing patterns of Loyal Customers vary.\n"
                f"Customer Value:\n"
                ...
                f"03. Potential Loyalists:\n"
                f"Purchasing Patterns:\n"
                f"    Discuss how purchasing patterns of Potential Loyalists vary.\n"
                f"Customer Value:\n"
                ...
                f"04. Recent Customers:\n"
                f"Purchasing Patterns:\n"
                f"    Discuss how purchasing patterns of Recent Customers vary.\n"
                f"Customer Value:\n"
                ...
                f"05. Promising:\n"
                f"Purchasing Patterns:\n"
                f"    Discuss how purchasing patterns of Promising customers vary.\n"
                f"Customer Value:\n"
                ...
                f"06. Need Attention:\n"
                f"Purchasing Patterns:\n"
                f"    Discuss how purchasing patterns of customers who Need Attention vary.\n"
                f"Customer Value:\n"
                ...
                f"07. About to Sleep:\n"
                f"Purchasing Patterns:\n"
                f"    Discuss how purchasing patterns of customers who are About to Sleep vary.\n"
                f"Customer Value:\n"
                ...
                f"08. Can't Lose:\n"
                f"Purchasing Patterns:\n"
                f"    Discuss how purchasing patterns of customers who Can't Lose vary.\n"
                f"Customer Value:\n"
                ...
                f"09. At Risk:\n"
                f"Purchasing Patterns:\n"
                f"    Discuss how purchasing patterns of customers who are At Risk vary.\n"
                f"Customer Value:\n"
                ...
                f"10. Hibernating:\n"
                f"Purchasing Patterns:\n"
                f"    Discuss how purchasing patterns of Hibernating customers vary.\n"
                f"Customer Value:\n"
                ...
                f"11. Lost:\n"
                f"Purchasing Patterns:\n"
                f"    Discuss how purchasing patterns of Lost customers vary.\n"
                f"Customer Value:\n"
